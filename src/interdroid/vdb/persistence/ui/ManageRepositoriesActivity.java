...
//                // Re-edit the schema and try again.
//                Intent editRepo = new Intent(Intent.ACTION_EDIT, data.getData());
//                editRepo.putExtra(AvroBaseEditor.SCHEMA, AvroSchema.RECORD.toString());
//                editRepo.putExtra(AvroBaseEditor.ENTITY, AvroSchema.RECORD_DEFINITION);
//                startActivityForResult(editRepo, CREATE_REPOSITORY);
            }
            break;
    ...
    private void launchListActivity(Uri uri) {
        ...
        try {
            ...
            try {
                logger.debug("Starting non-native view for: {}", uri);
